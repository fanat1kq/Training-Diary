...
Склоинруйте репозиторий на свой ПК Откройте проект в IntelliJ IDEA. Запустите класс "Main", для запуска консольного меню. Далее следуйте инструкциям консольного меню. Технологии

Java core JUnit Maven
