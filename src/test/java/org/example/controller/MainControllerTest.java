...
//        Mockito.when(securityService.register(user)).thenReturn(expected);
//
...
//
//        User expected = new User(login, password,Role.ADMIN);
//        Mockito.when(securityService.authorization(new User(login, password,Role.ADMIN))).thenReturn(expected);
//
