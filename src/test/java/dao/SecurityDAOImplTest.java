...
public class SecurityDAOImplTest {
    ...
    @BeforeEach
    void refresh() {
        securityDAO = new SecurityDAOImpl(new ConnectionManager());
        securityDAO.save(user1);
        securityDAO.save(user2);
        securityDAO.save(user3);
    }
    @AfterEach
    void tearDown() {
        securityDAO = null;
    ...
    void testSave() {
        ...
        User result = securityDAO.save(newPlayer);
